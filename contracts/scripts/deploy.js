...
async function main() {
    console.log("🚀 Starting Vital Vaultcontract deployment...\n");
    ...
    if (hre.network.name !== "localhost" && hre.network.name !== "hardhat") {
        ...
        try {
            ...
            console.log(" PatientRegistry verification failed:", error.message);
        }
        ...
        try {
            ...
            console.log(" DoctorRegistry verification failed:", error.message);
        }

# Vital Vault- Implementation Details
...
Vital Vaultis a decentralized healthcare records management system that leverages blockchain technology for secure, immutable storage of medical records with encrypted file storage on IPFS.
